<?php
    ...
    class WPS_PRO_Profile_Widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
            <div><center>Select Avatar Size Below (pixels):</center></div>
            ...
            <select id="<?php echo $this->get_field_id( 'avtar_size' ); ?>" name="<?php echo $this->get_field_name('avtar_size'); ?>">
                ...
                <?php
                    echo '<option value="50"'. selected( $avtar_size, '50', false ). '>50 by 50</option>';
					echo '<option value="75"'. selected( $avtar_size, '75', false ). '>75 by 75</option>';
					echo '<option value="100"'. selected( $avtar_size, '100', false ). '>100 by 100</option>';
					echo '<option value="150"'. selected( $avtar_size, '150', false ). '>150 by 150</option>';
					echo '<option value="200"'. selected( $avtar_size, '200', false ). '>200 by 200</option>';
					echo '<option value="250"'. selected( $avtar_size, '250', false ). '>250 by 250</option>';
					echo '<option value="300"'. selected( $avtar_size, '300', false ). '>300 by 300</option>';
                ?>
            </select>
            </p>
	        <p>
	        <div><center>Message Friends Button only works with WP Symposium Pro Extensions</center></div>
